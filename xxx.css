@font-face{font-family:'jazeera';src: url('https://www.fontstatic.com/fonts/jazeera/jazeera.eot?#iefix');src: local('ط§ظ„ط¬ط²ظٹط±ط©'), local('jazeera'),url('https://www.fontstatic.com/fonts/jazeera/jazeera.woff') format('woff');}
@font-face{font-family:'jazeera-light';src: url('https://www.fontstatic.com/fonts/jazeera-light/jazeera-light.eot?#iefix');src: local('ط§ظ„ط¬ط²ظٹط±ط© ط®ظپظٹظپ'), local('jazeera-light'),url('https://www.fontstatic.com/fonts/jazeera-light/jazeera-light.woff') format('woff');}

.fr.borderg a {color: #BA4E86;font-family: 'jazeera',FontAwesome;}
.fr.borderg {color: #BA4E86;}
.lonline.light.break .hand.nosel.fl.uzr.border >.fl {
    float: right;
    text-align: right;
}
...
div#tlogins .light.break {
    background-image: url(soon);
...
#asim7 {margin-bottom: 3px; height: 26px; color: #AD2856; border-radius: 5px 5px 5px 5px; border-bottom: 2px solid #FF0897; border-top: 2px solid #FF0897; padding-bottom: 2px!important; font-family: 'jazeera',FontAwesome; font-size: 16px!important; padding: 2px 10px 2px 10px;}
...
#asim8 {background-image:url(https://iqr30.com/sico/z1ccppo1j810.png);font-family: 'jazeera-light',FontAwesome;margin-bottom: 2px; background-color: #D43B7D; height: 28px; color: #FFFFFA; border-radius: 5px 5px 5px 5px; border-bottom: 2px solid #FF0897; border-top: 2px solid #FF0897; padding-bottom: 2px!important;
...
ul.nav.nav-tabs.fl li a {font-family: 'jazeera',FontAwesome;font-size: 13px!important;padding: 4px!important;text-align: center!important;border-radius: 5px 5px 0px 0px;width: 100%;color: #bd4b87;}
...
ul.nav.nav-tabs.fl li a:hover {background-color: #FF3333;color: white;}
ul.nav.nav-tabs.fl li {width: 33.3%;border-top: 2px solid #EB047C;border-radius: 5px 5px 0px 0px;background-color: #FDF0F8;border-bottom: 3px solid #f50784;}
fa.fa-user {border-radius: 10px 10px 10px 10px;}
ul.nav.nav-tabs.fl li a {font-family: 'jazeera',FontAwesome;font-size: 13px!important;padding: 4px!important;text-align: center!important;border-radius: 5px 5px 0px 0px;width: 100%;color: #bd4b87;}
...
body , .tablebox.footer.fl.light, .break.fr {background-image: url(https://iqr30.com/sico/z1c75j5o5l10.png)}
...
label.label-primary {border-radius: 15px;}
...
.brooms.minix.badge.border, .minix.badge.border, .corner.border.label.label-primary {
    ...
    background-image:url(https://iqr30.com/sico/z1cbht7f6r10.png);
}
...
.fl.nosel.label.pnhead, .label.fl.hand.fa.fa-info.title {font-family: 'jazeera',FontAwesome;
color: #AD2856;}
#asim55 {border-top: 2px solid #f50784; border-bottom: 2px solid #f50784; margin-bottom: 2px; border-radius: 5px 5px 5px 5px;font-family: 'jazeera',FontAwesome;color: #AD2856;}
...
.lonline.light.break .hand.nosel.fl.uzr.border .fr.co {
	float: left;
}

.lonline.light.break img.fl.u-ico {
    float: right;
}
...
{
	background-image:url(https://iqr30.com/sico/z1ccppo1j810.png)
}
.a {background-color: #FFFFFF; border-radius: 15px 15px 15px 15px; font-family: 'jazeera',FontAwesome; padding: 2px 10px 2px 10px; margin:7px 10px 7px 10px;color: #ba3c66;}
